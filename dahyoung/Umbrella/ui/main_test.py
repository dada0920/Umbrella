...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listWidget1 = QtWidgets.QListWidget(self.page)
        self.listWidget1.setGeometry(QtCore.QRect(20, 480, 420, 251))
        ...
        self.listWidget2 = QtWidgets.QListWidget(self.page)
        self.listWidget2.setGeometry(QtCore.QRect(460, 480, 420, 251))
